...
public class RangeColorGenerator {
    ...
    public RangeColorGenerator(double max) {
        ...
        Label l = new Label("<center style= 'margin-left:-20px;font-size: 1vmin;width:15px !important; height:15px !important;letter-spacing: 10px !important;'>0</center>", ContentMode.HTML);
        l.setSizeFull();
